...
var morgan_config_1 = require("./morgan.config");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    app.enableCors();
                    app.use(morgan_config_1.morganMiddleware);
                    return [4 /*yield*/, app.listen(port)];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, figlet('                NEST', function (err, data) {
                            if (err) {
                            ...
                            console.log(chalk.yellow('    🎯 🐢 REST API Server is running on ') +
                                chalk.italic.green("http://0.0.0.0:" + port + "/api/swagger \uD83D\uDC22 \uD83C\uDFAF "));
                            console.log('');
                            console.log(chalk.yellow('    🎯 🐢 GRAPHQL API Server is running on ') +
